"""
Topic: 06_Data Structures — Graph & Connectivity
Subtopic: Shortest Paths: Dijkstra, Bellman-Ford, A*, Floyd-Warshall, 0-1 BFS, Johnson’s, SPFA, DAG shortest path (topo order)
